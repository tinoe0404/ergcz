...
export default function OurStory() {
  ...
  // Project Y upwards by 30% of its size during scroll
  const y = useTransform(scrollYProgress, [0, 1], ["0%", "-30%"]);

  return (
    <section className="py-24 px-6 md:px-12 bg-white overflow-hidden">
      <div ref={ref} className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16">
        ...
        >
          ...
          <div className="relative z-10 w-full aspect-square md:aspect-[4/3] rounded-xl overflow-hidden shadow-xl bg-slate-100">
            <motion.div style={{ y, height: "130%" }} className="absolute inset-0">
              <Image 
